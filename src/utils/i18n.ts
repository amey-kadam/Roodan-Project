...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'products.meatDesc': 'Beef, Chicken & Beef Ghee',
    'products.oil': 'Vegetable Oils',
    'products.oilDesc': 'CP8, CP10 & Olive Oil',
    'products.rice': 'Rice',
  ...
  fr: {
    ...
    'products.meatDesc': 'Bœuf, Poulet & Ghee de Bœuf',
    'products.oil': 'Huiles Végétales',
    'products.oilDesc': 'CP8, CP10 & Huile d\'Olive',
    'products.rice': 'Riz',
  ...
  ar: {
    ...
    'strengths.reliability.desc': 'شريك موثوق به مع تسليم ثابت',
    ...
    'strengths.flexibility.desc': 'حلول مخصصة لاحتياجاتك المحددة',
