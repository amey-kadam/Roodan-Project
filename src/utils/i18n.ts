...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    'products.noProductsMatching': 'Aucun produit correspondant à "{query}" dans la catégorie {category}.',
    'products.noProductsInCategory': 'Aucun produit disponible dans la catégorie {category}.',
    ...
    'product.petroleum.detail3': 'Livraison: CIF, FOB',
