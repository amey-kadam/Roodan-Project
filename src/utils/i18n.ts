...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    'products.sugarDesc': 'ICUMSA 45, ICUMSA 100, ICUMSA 150',
    'products.soy': 'Produits de Soja',
    'products.soyDesc': 'Graines de soja, Farine de soja, Huile de soja',
    'products.coffee': 'Café',
    'products.coffeeDesc': 'Robusta & Arabica',
    'products.meat': 'Produits de viande',
    'products.meatDesc': 'Viande de buffle, Poulet & Ghee de vache',
