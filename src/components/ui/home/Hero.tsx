...
function HeroComponent() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        {/* Full Height Gradient Background - Improved for mobile */}
        <div className="absolute inset-0 bg-gradient-to-br from-background via-background/80 to-primary/10 opacity-100 md:opacity-90" />
        
        {/* Layered Grid Pattern */}
        <div className="absolute inset-0 bg-[url('/grid.svg')] bg-repeat opacity-10" />
        
        {/* Animated Floating Shapes - Optimized for mobile */}
        <motion.div
          className="absolute w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-primary/5 rounded-full blur-3xl -top-32 -left-32 md:-top-64 md:-left-64"
        ...
        />
        <motion.div
          className="absolute w-[350px] h-[350px] md:w-[700px] md:h-[700px] bg-secondary/5 rounded-full blur-3xl -bottom-32 -right-32 md:-bottom-64 md:-right-64"
          variants={floatingVariants}
          initial="initial"
          animate="animate"
          transition={{ delay: 2 }}
        ...
        {/* Extended Geometric Overlay - Adjusted for better mobile visibility */}
      ...
      >
        ...
        >
          ...
          <div className="mb-12 md:mb-24"> {/* Adjusted margin for mobile */}
            <motion.h1
          ...
          <motion.div
            className="hero-element opacity-0 translate-y-12 flex flex-col sm:flex-row flex-wrap justify-center gap-4 md:gap-5 pt-6 md:pt-8"
          >
            <Button
              size="lg"
              asChild
              className="group h-12 md:h-14 px-6 md:px-8 rounded-xl md:rounded-2xl transition-all shadow-lg hover:shadow-emerald-600/30 w-full sm:w-auto"
              style={{
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="group h-12 md:h-14 px-6 md:px-8 rounded-xl md:rounded-2xl border-2 border-emerald-600 bg-background/50 hover:bg-emerald-50/20 transition-all shadow-lg hover:shadow-emerald-600/30 w-full sm:w-auto"
            >
              <NavLink
                to="/contact"
                className="flex items-center justify-center gap-3 text-base md:text-lg font-semibold bg-clip-text text-transparent"
                style={{
      ...
      >
        <div className="w-6 h-10 md:w-8 md:h-12 rounded-3xl border-2 border-border flex justify-center p-1">
          <motion.div
