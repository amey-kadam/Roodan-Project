        ...
        >
          ...
          >
            <div className="flex flex-col items-center justify-center gap-3 mb-10">
              <h2 className="text-4xl md:text-5xl font-display mt-2 font-bold text-center text-gray-800">
...
>>>>>>> 098a38c30b7b58056d665990dd667e166cbe9d93
          initial="initial"
          whileInView="animate"
          viewport={{ once: true }}
        >
...
<<<<<<< HEAD
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 mt-12">
              {[
                { icon: "LifeBuoy", title: "service1" },
                { icon: "ShieldCheck", title: "service2" },
              ].map((service, index) => (
                <motion.div
                  key={`value-${index}`}
                  variants={itemVariants}
                ...
                >
                  <div className="flex flex-col h-full">
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="text-lg md:text-xl font-display font-semibold mb-2 text-gray-800 truncate">
                        {t(`about.service.${service.title}.title`)}
                      </h3>
                      <p className="text-gray-600 text-sm md:text-base">
                        {t(`about.service.${service.title}.desc`)}
                      </p>
=======
...
>>>>>>> 098a38c30b7b58056d665990dd667e166cbe9d93
        ...
        >
          ...
          <motion.div
            variants={sectionVariants}
            className="max-w-5xl mx-auto px-10 relative z-10"
          >
            <div className="flex flex-col items-center justify-center gap-3 mb-10">
              <motion.div
